  ...
  return (
    <ClinicEmailWrapper {...props}>
      <Item>
        ...
        <SubHeaderContainer>
          <SubHeader>
            Please click the button below to confirm your appointment or call <A href="#" style={linkStyle} className="linkTextBold" ><Bold>*|ACCOUNT_PHONENUMBER|*</Bold></A> to reschedule. Please note,
